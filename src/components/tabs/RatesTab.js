    ...
    <div className="space-y-4">
      <div className="ledger-card overflow-hidden">
        <div className="px-4 sm:px-5 pt-4 pb-2">
          ...
          <p className="text-[11px] mono text-[var(--faint)] mt-1">
  ...
  return (
    <tr className="border-b last:border-0" style={{ borderColor: "var(--line)" }}>
      ...
      <td className="px-3 py-2.5 text-xs text-[var(--muted)]">
        {rate.note}
        {rate.source_url && (
          <a href={rate.source_url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-0.5 ml-1.5 hover:opacity-80" style={{ color: "var(--cyan)" }}>
    ...
    <div className="ledger-card p-4 sm:p-5">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        ...
        <div className="col-span-2 sm:col-span-3">
          <label htmlFor="new-rate-source" className="block text-[10px] mono text-[var(--muted)] mb-1">SOURCE URL</label>
